...
public class CheckOutPage {
    ...
    private final By newAddress = By.id("billing-address-select");

    // private final By clickNewAddress =
    // By.xpath("//select[name='billing_address_id']/");
    public void clickProceedToCheckout() {
        driver.findElement(proceedToCheckoutSelector).click();
    }

    public void clickNewAddress() {
        WebElement dropdownElement = driver.findElement(newAddress);
    ...
    public void clickShippingAddress() {
        WebElement dropdownElement = driver.findElement(newShippingAddressBox);
        // if(dropdownElement.isDisplayed()){
        Select selectOption = new Select(dropdownElement);
        selectOption.selectByVisibleText("New Address");
        // }
